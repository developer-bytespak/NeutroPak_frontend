  ...
  return (
    <main>
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(/cart_sec.png)',
        }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-50" />
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-2">Cart</h1>
          <p className="text-lg text-yellow-50">Review your items before checkout</p>
        </div>
      </section>
