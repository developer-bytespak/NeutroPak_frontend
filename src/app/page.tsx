...
const HomePage = () => {
  ...
  return (
    <main className="overflow-x-hidden">
      ...
      {/* Why Choose Section */}
      <section className="py-12 sm:py-16 md:py-20 bg-gold-200 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="space-y-3">
              {valueProps.map((prop, idx) => (
                <div key={idx} className="group bg-gold-300 rounded-lg p-3 sm:p-3 md:p-5 flex gap-3 items-start border-2 border-gold-400 hover:shadow-lg transition-shadow">
                  <div className="bg-gold-300 rounded-full w-14 sm:w-16 md:w-18 h-14 sm:h-16 md:h-18 flex items-center justify-center flex-shrink-0 text-lg sm:text-xl md:text-2xl group-hover:bg-red-800 transition-colors duration-300">
                    {prop.icon}
                  </div>
                  <div>
