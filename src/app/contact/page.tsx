              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:nutreopak@gmail.com" className="font-semibold text-gray-900 hover:text-red-900">
                      nutreopak@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-gray-600 text-sm">Phone (NutreoPak Official) :</p>
